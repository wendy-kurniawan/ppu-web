                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Rangking Narasumber</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design text-center">
                                <li class="active"><a href="#listPermintaan">Rangking Narasumber</a></li>
                            </ul>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                    <table id="example" class=" table display table-bordered responsive no-wrap" style="width:100%">
                                                            ...
                                                            <tbody>
                                                                @foreach ($rangkingBoard as $itemRanking)
                                                                <tr>
                                                                    <td>{{$no++}}</td>
                                                                    <td>{{$itemRanking->NAMALENGKAP}}</td>
                                                                    <td>
                                                                        @if ($itemRanking->totalKegiatanNarasumber != 0)
                                                                            {{($itemRanking->rank/$itemRanking->totalKegiatanNarasumber)}}%
                                                                        @else
                                                                            0%
                                                                        @endif    
                                                                    </td>     
