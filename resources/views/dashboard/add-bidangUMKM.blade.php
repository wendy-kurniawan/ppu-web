                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        <div class="breadcome-heading">
                                            ...
                                            <h3>
                                                ...
                                                Pemerataan Pemberdayaan UMKM Input Bidang UMKM
                                            </h3>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Input Bidang UMKM</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design text-center">
                                <li class="active"><a href="#formbidangUMKM">Input Bidang UMKM</a></li>
                                <li><a href="#formDataUMKM"> Data Bidang UMKM</a></li>
                            </ul>
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="formbidangUMKM">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form id="add-department" action="{{route('bidangumkm.store')}}" method="POST" class="add-department">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                <label>Jenis Bidang UMKM</label>
                                                                <input name="jenisUMKM" type="text" class="form-control"
